// Ported from https://reactbits.dev (StaggeredMenu-JS-CSS) to TypeScript, with
// two adaptations for this site: no logo image asset exists, so `logoUrl` is
// optional and falls back to clickable text (`logoText`/`onLogoClick`); and
// since nav items here are same-page anchors (not real route changes), each
// item closes the menu on click — the upstream component doesn't do this
// because for real page navigation it doesn't need to.
      ...
      >
        <div className="sm-logo" aria-label="Logo">
          {logoUrl ? (
            ...
            <button type="button" onClick={onLogoClick} className="sm-logo-text">
              {logoText}
            </button>
          )}
        </div>
